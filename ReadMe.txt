========================================================================
       MICROSOFT FOUNDATION CLASS BIBLIOTHEK : bm_play
========================================================================


Diese bm_play-Anwendung hat der Klassen-Assistent für Sie erstellt. Diese Anwendung
...
res\bm_play.ico
	...
	Symbol wird durch die Haupt-Ressourcendatei bm_play.rc eingebunden.
...
bm_playDlg.h, bm_playDlg.cpp - das Dialogfeld
    	Diese Dateien enthalten die Klasse CBm_playDlg. Diese Klasse legt das
    	Verhalten des Haupt-Dialogfelds der Anwendung fest. Die Vorlage des Dialog-
	felds befindet sich in bm_play.rc, die mit Microsoft Visual C++
...
StdAfx.h, StdAfx.cpp
	...
	bm_play.pch und eine vorkompilierte Typdatei mit der Bezeichnung StdAfx.obj
	erstellt.
